...
{
    [TestClass]
    public class ReactiveServerTests2
    {
        ...
        {
            var server = new SimpleReactiveTcpServer().Start(_serverPort, false);
        ...
        public void Start_passes_if_at_least_one_nic_is_free()
        {
            ...
            try
            {
                var server = new SimpleReactiveTcpServer().Start(_serverPort);
