//Temporarily used
//https://github.com/neuecc/UniRx/blob/master/Assets/Plugins/UniRx/Scripts/UnityEngineBridge/ReactiveCollection.cs
...
namespace UniRx
{
    internal struct CollectionAddEvent<T> : IEquatable<CollectionAddEvent<T>>
    {
    ...
    internal struct CollectionRemoveEvent<T> : IEquatable<CollectionRemoveEvent<T>>
    {
        public int Index { get; private set; }
        public T Value { get; private set; }
    ...
    internal struct CollectionMoveEvent<T> : IEquatable<CollectionMoveEvent<T>>
    {
    ...
    internal struct CollectionReplaceEvent<T> : IEquatable<CollectionReplaceEvent<T>>
    {
        public int Index { get; private set; }
    ...
    internal interface IReadOnlyReactiveCollection<T> : IEnumerable<T>
    {
        int Count { get; }
    ...
    internal interface IReactiveCollection<T> : IList<T>, IReadOnlyReactiveCollection<T>
    {
        new int Count { get; }
    ...
    [Serializable]
    internal class ReactiveCollection<T> : Collection<T>, IReactiveCollection<T>, IDisposable
    {
        [NonSerialized]
    ...
    internal static partial class ReactiveCollectionExtensions
    {
